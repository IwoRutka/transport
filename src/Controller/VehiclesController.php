...
class VehiclesController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('vehicles_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('vehicles/new.html.twig', [
            'vehicle' => $vehicle,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Vehicles $vehicle): Response
    {
        ...
        return $this->renderForm('vehicles/edit.html.twig', [
            'vehicle' => $vehicle,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="vehicles_delete", methods={"POST"})
     */
